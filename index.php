				...
				<div class="navbar-inner main-menu">				
					<nav id="menu" class="pull-right">
						<ul>
							...
							<li class="dropdown "><a href="#" id="drop1" data-toggle="dropdown" class="dropdown-toggle" role="button">Product <b class="caret"></b></a>
            <ul role="menu" class="dropdown-menu" aria-labelledby="drop1">
                <li role="presentation"><a href="#" role="menuitem">Product 1</a></li>
                <li role="presentation"><a href="#" role="menuitem">Product 2</a></li>
                <li role="presentation"><a href="#" role="menuitem">Product 3</a></li>
                <li role="presentation"><a href="#" role="menuitem">Product 4</a></li>
            </ul>
			</li>
...
<!--Footer-->
	            <!-- === BEGIN FOOTER === -->
                <section id="base" style="border-top:1px solid #DED8D8;height:0%;">
                    <div class="container-fluid bottom-border">
                        <div class="row" style="margin-top:10px;">
                            <!-- Disclaimer -->
								...
								<br><br><a href= "#" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Events</a>
								<br><a href= "#" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Press Releases</a>
								<br><a href= "#" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Investor Relations</a>
								<br><a href= "#" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Community Relations</a>
								...
								<br><br><a href= "return.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Return Policy</a>
								<br><a href= "ship.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Shipping Options</a>
                                <br><a href= "terms.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Terms and Conditions of Sale</a>
								<br><a href= "webterms.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Website Terms of Use</a>
								<br><a href= "privacy.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">Privacy Policy</a>
								...
								<br><br><a href= "faq.php" style=" font-family:-webkit-body;color:black;font-size: 15px;width:15px;color: #9E9E9E;">FAQs</a>
